...
Duplicate the selected Instrument/ Maze with all settings.

### Delete Maze

Delete the currently selected Maze from the Pattern.

### Interface shortcuts

Quick selection to add a Maze or in the Main Effects, Motions & Connections Interfaces.
