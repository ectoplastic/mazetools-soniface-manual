...
Start point of the selected movement. The position is saved individually for each Pattern.

## Mocap end

End point of the selected movement. The position is saved individually for each Pattern.
...
Starts the playback of a mocap. This interrupts the live tracking by the camera.

## Mocap Stop

Stops the playback of a mocap. This is a necessary condition for live tracking.

## Start Mocap Recording

Start recording your movements. Make sure that the avatar mirrors the movements well.

## Delete Mocap

Delete a mocap from the editor.

## Sync Mocap

The recorded mocap is synced to the Pattern sequence.

## Mocap Backward

On/off switch to play the mocap backwards.

## Mocap Forward& Backward

On/off switch to play the mocap forward and backward in the loop.

## Webcam Tracking On/Off
...
Switch for changing the device cameras (Front& Selfi), if several are available.

## Motion Visual On/Off

Switch for visualization of motion tracking and captures as miniature and on the Grid.

## Mirror Motion Visual

Mirrors the visualization of the mocaps.

## Mocap List

List of all captured motion captures.

## Load Mocap Preset

Tap on a preset in the list to load a mocap capture.

## Save Mocap Preset

Save a mocap capture as a preset

## Body Tracking Presets
