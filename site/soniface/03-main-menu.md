...
Plays or stops all LivePad s active in the pattern.
...
Information about menus, functions, the file directory, FAQ and background knowledge.
...
Infos, Credits and Terms of Use.

## Restart Mazetools Soniface

Tap twice to restart the app.

## Quit Mazetools Soniface

Tap twice to exit the app.
