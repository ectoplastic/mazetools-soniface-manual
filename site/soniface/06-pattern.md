...
Add a new Pattern, duplicate or delete a Pattern, or move their order.
...
Play and stop Soniface.

### Mute Soniface

Mute and unmute the current sound of Soniface.

### Automatic playback

This function switches the Patterns automatically. It works only with 2 or more Patterns in the list.
...
Tap twice to delete the currently selected Pattern (no undo).

### Pattern Shift

Verschiebe die Position des Patterns innerhalb der Liste nach oben oder unten.
